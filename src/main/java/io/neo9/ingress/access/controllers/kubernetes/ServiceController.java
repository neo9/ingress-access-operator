...
public class ServiceController extends ReconnectableSingleWatcher<Service, ServiceList> {
	...
	public ServiceController(KubernetesClient kubernetesClient, ServiceExposerReconciler serviceExposerReconciler, AdditionalWatchersConfig additionalWatchersConfig) {
		super(
				/* activation condition */
				additionalWatchersConfig.exposer().isEnabled(),
				/* unique name */
				"services-onLabel",
				/* watch what */
